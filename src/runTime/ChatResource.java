...
public class ChatResource {
    ...
    public void onOpen(RemoteEndpoint r, EventBus eventBus) {
     ...
     //   eventBus.publish(room + "/*", new Message(String.format("%s Nuevo usuario '%s'",  username, room), true));
    }
    ...
    public void onClose(RemoteEndpoint r, EventBus eventBus) {
       ...
       // eventBus.publish(room + "/*", new Message(String.format("%s ha salido de la habitación", username), true));
    }
 
    @OnMessage(decoders = {MessageDecoder.class}, encoders = {MessageEncoder.class})
    public Message onMessage(Message message) {
      System.out.println("evento : onMessage");

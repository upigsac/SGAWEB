...
(function ($) {
    ...
    ddslickCSS = '<style id="css-ddslick" type="text/css">' +
                ...
                '.dd-selected{ overflow:hidden; display:block; padding:5px; font-weight:bold;}' +
                ...
                '.dd-container{ position:relative;}​ .dd-selected-text { font-weight:bold;font-size:20px}​ .dd-option-text{font-size:20px}</style>';
